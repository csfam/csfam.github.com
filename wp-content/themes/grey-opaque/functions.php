...
define('THEME_VERSION', '1.3.0'); // The Themes Version
define('THEME_URI', 'http://grey-opaque.ppfeufer.de/'); // The Themes Page
							...
							<li>
								<div class="share">
									...
									<ul class="sharing">
										...
										<li>
											<a rel="nofollow" title="<?php _e('Tweet this!', 'grey-opaque'); ?>" id="share_twitter" href="https://twitter.com/intent/tweet?text=<?php echo $var_sTitle; ?>&url=<?php echo $var_sPermalink; echo (get_the_author_meta('twitter')) ? '&via=' . greyopaque_sanitize_twittername(get_the_author_meta('twitter')) . '&related=' . greyopaque_sanitize_twittername(get_the_author_meta('twitter')) : ''; ?>">Twitter</a>
										</li>
										<li class="last">
